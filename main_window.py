...
##    imagePath_warning=PhotoImage(file="warning.png")
##    widgetstart_warning=Label(master=new,image=imagePath_warning)
##    widgetstart_warning.place(x=0,y=0)
...
####                             settings = {'TMenubutton':
####                                         {'configure':
####                                          {'selectbackground': 'black',
####                                           'fieldbackground': '0',
####                                           'background': 'white',
####                                           'selectforebackground':'white',
####                                           'relief':'groove',
####                                           'bordercolor':'#cfcfcf',
####                                           'borderwidth':'0'
####                                           }}}
...
####    combostyle.theme_use('combostyle')
    ##imagePath_c=PhotoImage(file="c_sign12.png")
    ##widgetf_c=Label(root,image=imagePath_c)
    ##widgetf_c.place(x=750,y=50)
    ...
    def read_every_second():
        global q_1_s,clientsocket,address,s11
        t=time.localtime()
        current_time_1=time.strftime("%H:%M:%S",t)
##        label_intime = Label(root, text=str(current_time_1),bg='#efeeef',fg='#231f1e', font=('Arial', 15))
##        label_intime.place(x=850,y=50)
        ...
        entry_temperature.place(x=470,y=50,width=60)
        degree_sign=u'\u00B0'
    ...
    def read_every_second_faisal():
        global q_1_s_faisal,clientsocket,address,s11
        today = date.today()
        ...
        #label_indate = Label(root, text=str(d1),bg='#efeeef',fg='#231f1e', font=('Arial', 15,'bold'))
        #label_indate.place(x=850,y=10)
        q_1_s_faisal+=1
        if q_1_s_faisal>70:
    #        graph1.draw_axes()
            q_1_s_faisal=0
...
##    f4 = Frame(root,height=500,width=1024,relief='sunken',borderwidth=1)
##     # fill window
##    
##
...
##    f_popup = Frame(root,height=100,width=100,relief='raised',borderwidth=1)
##    f_popup.configure(bg='white')

    for frame in (f1, f2, f3, f4,f5,f6,f7,f8,f_addnewuser,f_setting,f_ins_setting,f_servicemode,f_servicemode1,f_about,f_graph):
    ...
    l_faisal=[]
    l_e4,l_e5,l_e6,l_e7,l_e8=[0],[0],[0],[0],[0]
    current=200
    current_1=200
    dict_1={}
    l_infinite=[]
    ...
    lena="drop.png"
    def back_new():
        global lena,OptionList2,variable2,s11
        clientsocket,address=s11.accept()
...
####        #imagePath_drop2=PhotoImage(file=k1)
####        widgetdrop2=Label(f5,borderwidth=0,image=ph)
####        widgetdrop2.place(x=928,y=322)
...
##    image_meter=Image.open("2dial.png")
##    filename_meter = ImageTk.PhotoImage(image_meter)
##    canvas = Canvas(f1,height=555,width=555)     
##    canvas.image = filename_meter  # <--- keep reference of your image
##    canvas.create_image(0,0,anchor='nw',image=filename_meter)
##        #canvas.grid(row=508,column=8005)
##    canvas.place(x=650,y=90)
##    p1 = gaugelib.DrawGauge2(f1,max_value=300.0,min_value=0.0,size=200,bg_col='white',unit = "Temperature",bg_sel = 4)
##    p1.config(borderwidth=2)
##    p1.place(x=750,y=190)
####    p1 = gaugelib.DrawGauge2(f1,max_value=300.0,min_value=0.0,size=350,bg_col='#f7f7ff',unit = "Temperature",bg_sel = 4)
####    p1.config(borderwidth=0)
####    p1.place(x=650,y=100)
    #f1.overrideredirect(True)
    #p1.geometry("+250+250")
    
##
##    image_meter=PhotoImage(file="2dial.png")
##    widgetmeter=Label(f1,image=image_meter)
##    widgetmeter.configure(borderwidth=0)
##    widgetmeter.place(x=650,y=90)
##
##    canvas = Canvas(f1,height=170,width=140)
##    canvas.configure(borderwidth=0,bg='#f7f7ff')
##    canvas.create_line(15, 25, 200, 25)
##    canvas.place(x=750,y=165)
    

    #p1.wm_attributes("-topmost", True)
    #p1.wm_attributes("-disabled", True)
    #p1.wm_attributes("-transparentcolor", "white")
##    image = Image.open('Audi.jpg')
##    # rotate 270 degrees counter-clockwise
##    imRotate = image.rotate(270)
##    filename = "AudiRotated2.jpg"
##    imRotate.save(filename)
####    image_meter1=Image.open("arrow2.png")
####    image_meter2 = image_meter1.rotate(0)
####    
####    filename_meter1 = ImageTk.PhotoImage(image_meter2)
####    canvas = Canvas(f1,width=60,height=150)     
####    canvas.image = filename_meter1  # <--- keep reference of your image
####    canvas.create_image(5,2,anchor='nw',image=filename_meter1)
####        #canvas.grid(row=508,column=8005)
####    canvas.place(x=805,y=138)
##    image_meter1=PhotoImage(file="arrow2.png")
##    #image_meter1.rotate(270)
##    widgetmeter1=Label(f1,image=image_meter1)
##    widgetmeter1.configure(borderwidth=0)
##    widgetmeter1.place(x=805,y=138)
    ...
    def call_2(event):
        global l_type,l_entry_e5,l_e4,l_infinite
        print('entry')
    ...
    def call_name(event):
        global l_type,l_entry,l_e4,l_entry_call_name
        print('entry')
        e3.delete(0,END)
        t=e_name.get()
    ...
    def call_designation(event):
        global l_type,l_entry,l_e4,l_entry_call_designation
        print('entry')
        e3.delete(0,END)
        t=e_designation.get()
    ...
    def call_contact(event):
        global l_type,l_entry,l_e4,l_entry_call_contact
        print('entry')
        e2.delete(0,END)
        f_addnewuser.focus()
        t=e_contact.get()
        ...
        if l_entry_call_contact[-1] =='None':
            ...
            #e2.delete(0,END)
            e2.insert(0,l_entry_call_contact[-1])
            l_entry.clear()
        l_e4.append('call_contact')
        raise_frame(f2)
    def call_employeid(event):
        global l_type,l_entry,l_e4,l_entry_call_employeid
        print('entry')
        e3.delete(0,END)
        e3.config(font=('arial',21),takefocus='off',borderwidth='2')
        t=e_employeid.get()
    ...
    Button(f_graph,text="Home",font=('Arial',15),command=back).place(x=50,y=50)
    def click():
       global variable1,variable1,variable2,e4,e5,e6,OptionList2,s11
       print(e5.get())
       print(len(variable1.get()),len(variable.get()),len(variable2.get()),len(e4.get()),e5.get(),e6.get())
...
##        #del dict_1[cf_1[0]]
    ...
    def add_user():
        ...
        def edit_user(q_edit):
            ...
            if(len(e_name.get())!=0 and len(e_employeid.get()) !=0) :
                ...
                for last_1 in list_xqqq:
                        a=last_1
                        Button(f4.scrollFrame.viewPort,bg='#4299ff',fg='white', text="DELETE",font=('Arial',10,'bold'), command=lambda x=a: delete_1(x)).place(x=815, y=current_1,width=70,height=50)
                        Button(f4.scrollFrame.viewPort,bg='#4299ff',fg='white', text="EDIT",font=('Arial',10,'bold'), command=lambda x=a: edit_1(x)).place(x=900, y=current_1,width=70,height=50)
                        print(list_faisal)
        ...
        def delete_1(q_1):
            ...
            #print('delete')
            def delete_2(q_1):
                    global list_delete,dict_1,current
...
####    widgetstart.place(x=85,y=110,width=200,height=90)
    ...
    widgetstart_results=Button(f1,image=imagePath_results)
    widgetstart_results.place(x=340,y=90)
    imagePath_damper=PhotoImage(file="about.png")
    widgetstart_damper=Button(f1,borderwidth=1,image=imagePath_damper,command='')
    ...
    label_about=Button(master=f1,text="About",font=('Arial',22,'bold'),fg='black',relief='raised',borderwidth=0,command='').place(x=420,y=244)
...
####    comboExample = ttk.Combobox(f5, 
####                            values=[
####                                    "January", 
####                                    "February",
####                                    "March",
####                                    "April"])
####    comboExample.place(x=690,y=324,width=235,height=40)
####
####    opt1 = OptionMenu(f5, variable, *OptionList)
####    opt1.config( bg='white',font=('Arial', 12),relief="groove",borderwidth=0)
####    opt1.place(x=688,y=322,width=239,height=38)

    
##
##    e7 = Entry(f5)
##    e7.config(font=('arial',21),takefocus='off')
##    e7.place(x=950,y=200,height=35,width=180)
##    e7.bind("<FocusIn>",call_4)
##
##    e8 = Entry(f5)
##    e8.config(font=('arial',21),takefocus='off')
##    e8.place(x=950,y=250,height=35,width=180)
##    e8.bind("<FocusIn>",call_4)
####
####    
##    e9 = Entry(f5)
##    e9.config(font=('arial',21),takefocus='off')
##    e9.place(x=950,y=300,height=35,width=180)
##    e9.bind("<FocusIn>",call_4)
##
####    e7 = Entry(f5)
####    e7.config(font=('arial',21),takefocus='off',relief="groove",borderwidth=0,justify=CENTER)
####    e7.place(x=690,y=377,height=41,width=238)
####    e7.bind("<FocusIn>",call_4)
...
####    label_set_parameters = Label(f5, text="File Name",bg='white',fg='#231f1e', font=('Arial', 15,'bold'))
####    label_set_parameters.place(x=100,y=390)
##    label_set_parameters = Label(f5, text="Set Value:",bg='#f7f7ff',fg='#231f1e', font=('Arial', 15,'bold'))
##    label_set_parameters.place(x=830,y=110)
##    label_set_parameters = Label(f5, text="Set Value:",bg='#f7f7ff',fg='#231f1e', font=('Arial', 15,'bold'))
##    label_set_parameters.place(x=830,y=160)
##    label_set_parameters = Label(f5, text="Set Value:",bg='#f7f7ff',fg='#231f1e', font=('Arial', 15,'bold'))
##    label_set_parameters.place(x=830,y=210)
##    label_set_parameters = Label(f5, text="Set Value:",bg='#f7f7ff',fg='#231f1e', font=('Arial', 15,'bold'))
##    label_set_parameters.place(x=830,y=260)
##    label_set_parameters = Label(f5, text="Select Name",bg='#f7f7ff',fg='#231f1e', font=('Arial', 15,'bold'))
##    label_set_parameters.place(x=800,y=310)
##    label_set_parameters = Label(f5, text=" Enter File Name",bg='#f7f7ff',fg='#231f1e', font=('Arial', 15,'bold'))
##    label_set_parameters.place(x=780,y=360)
...
#######################################################SETTINGS#######################################################################################
    def instrument_setting():
        ...
        #thread4 = threading.Thread(target = read_every_second_faisal_12(), args = ())
        #thread4.start()
   # Label(master=f_ins_setting,bg='white',fg='black', text="C",font=('Arial', 16,'bold')).place(x=270,y=390)
    ...
    Button(master=f_setting,borderwidth='0',relief='flat',fg='black', text="Instrument",font=('Arial', 22,'bold'),command=lambda:raise_frame(f_ins_setting)).place(x=465,y=122)
    Button(master=f_setting,borderwidth='0',relief='flat',fg='black', text="Service",font=('Arial', 22,'bold'),command=lambda:raise_frame(f_servicemode)).place(x=465,y=263)

    
    button1 = Button(master=f_setting,width=10,height=1,bg='#4299ff',fg='white', text="Back",font=('Arial', 16,'bold'), command=back).place(x=450,y=385)
    Label(master=f_setting,width=10,height=1,bg='#f7f7ff',fg='black', text="Settings",font=('Arial', 18,'bold')).place(x=450,y=17)
...
#######################################################INSTRUMENT SETTING #############################################################################
    ...
    def save_time():
       ...
       if(x==True):
           Label(master=f5,bg='#00afef',fg='white', text="C",font=('Arial', 16,'bold')).place(x=935,y=109)
       if(x==False):
           Label(master=f5,bg='#00afef',fg='white', text="F",font=('Arial', 16,'bold')).place(x=932,y=109)
...
##    checkbox = Checkbutton(f_ins_setting, variable=vartime,command=current_value, text='')
##    checkbox.pack()
    #print (checkbox.cget('text'))
    #Label(master=f_ins_setting,width=19,height=0,variable=vartime).place(x=90,y=329)

##    thread5=threading.Thread(target = current_value(), args = ())
##    thread5.start()
    
##################################################Service mode###############################################################################################
    
    def call_password(event):
        global l_type,l_entry,l_e4,l_entry_password
        print('entry')
        e3.delete(0,END)
...
###################################################################About Us ###########################################################################################        
    ...
    e_server = Text(f_about.scrollFrame.viewPort) ## minutes entry widget
    e_server.config(font=('arial',21),fg='gray',relief="groove",borderwidth=2)
...
#e_server.bind("<FocusIn>",call_3)
    ...
    Button(master=f_about.scrollFrame.viewPort,width=10,height=1,bg='#4299ff',fg='white', text="Back",font=('Arial', 16,'bold'), command=lambda:raise_frame(f1)).place(x=830,y=50)
...
####    e_password = Entry(f_servicemode1)
####    e_password.config(font=('arial',21),takefocus='off',borderwidth='2',show='')
####    e_password.place(x=380,y=140,height=35,width=320)
####    e_password.bind("<FocusIn>",call_password)
####    
...
####    Button(master=f_servicemode,width=26,height=1,bg='#4299ff',fg='white', text="Back",font=('Arial', 14,'bold'), command=lambda:raise_frame(f_setting)).place(x=380,y=320)
    ...
    def clear():
        ...
        if (key<=0):
            key=0
    def enter():
        global l_type,l_entry_e4,l_entry_e5,l_entry_e6,l_e4,l_e5
        #e1.delete(0,END)
        y=e2.get()
        y=str(y)
        #e1.insert(0,y)
    ...
    def clear_f6():
        ...
        if (key<=0):
            key=0
    def enter_f6():
        global l_type,l_entry_e4,l_entry_e5,l_entry_e6,l_e4,l_e5,l_entry_call_name,l_entry_call_designation,l_entry_call_contact,l_entry_call_employeid
        #e1.delete(0,END)
        y=e8.get()
        y=str(y)
        #e1.insert(0,y)
    ...
    def infinte():
        global l_type,l_entry_e4,l_entry_e5,l_entry_e6,l_e4,l_e5,l_infinite
    ...
    ##    
    ##    button_1 = Button(master=f2,width=17,height=1,bg='white',fg='black', text="31",font=('Arial', 25,'bold'),borderwidth=0, command=show1).place(x=55,y=110)
    ##    button_2 =Button(master=f2,width=17,height=1,bg='white',fg='black', text="32",font=('Arial', 25,'bold'),borderwidth=0, command=show2).place(x=420,y=110)
    ##    button_3 = Button(master=f2,width=17,height=1,bg='white',fg='black', text="33",font=('Arial', 25,'bold'),borderwidth=0, command=show3).place(x=785,y=110)
    ##    button_4 = Button(master=f2,width=17,height=1,bg='white',fg='black', text="34",font=('Arial', 25,'bold'),borderwidth=0, command=show4).place(x=55,y=185)
    ##    button_10 = Button(master=f2,width=17,height=1,bg='white',fg='black', text="123",font=('Arial', 25,'bold'),borderwidth=0, command=change_1).place(x=55,y=335)
        

##    e2 = Entry(f2)
##    e2.config(justify=LEFT,font=('arial',21),takefocus='on')
##    e2.place(x=52,y=10,height=85,width=1100)
####    imagePath_k_b=PhotoImage(file="k_b_1.png")
####    widgetf=Label(f2,image=imagePath_k_b)
####    widgetf.place(x=47,y=103)
    def limitSizeDay(*args):
        ...
        if(l_e4[-1]=="call_contact"):
            ...
            if (ha_2>0):
                if len(value) > 13: dayValue.set(value[:13])
...
##        raise_frame(f1)
    ...
    #Button(f4, text='Back', command=lambda:raise_frame(f1),font=('Arial',10)).place(x=805,y=127,width=100,height=10)
    ...
    def read_every_second_1():
        global q_1_s_1,l_infinite,l_e4,l_e5,l_e6,l_e7,l_e8,l_entry_e4,l_entry_e5,l_entry_e6,l_entry_e7,l_entry,l_type
        print(l_infinite)
        print(l_e4,l_e5,l_e6,l_e7,l_e8)
        print(l_entry_e4,l_entry_e5,l_entry_e6,l_entry_e7)
        print(l_entry)
        print(l_type)

        if (len(e4.get())!=0 and len(e5.get()) !=0 and len(e6.get()) !=0):
            button2 = Button(master=f5,width=22,height=2,bg='#4299ff',fg='white', text="Start To Run A Test",activeforeground = "#75f07a",activebackground = "black",font=('Arial', 16,'bold'),command=back).place(x=670,y=21)

        else:
            button2 = Button(master=f5,width=22,height=2,bg='#f7f7f7',fg='green', text="Start To Run A Test",activeforeground = "#75f07a",activebackground = "black",font=('Arial', 16,'bold'),command=cannotenter).place(x=670,y=21)
  


####        label_temp = Label(f5, text='80 C',bg='#efeeef',fg='#231f1e', font=('Arial', 18,'bold'))
####        label_temp.place(x=470,y=52)
    ...
    #        graph1.draw_axes()
            q_1_s_1=0
        root.after(2000, read_every_second_1)
   # read_every_second_1()
    def gfg(): 
        print("GeeksforGeeks\n")
        with open('meter.txt','w') as f:
            n=f.write('open')
            print(n)
