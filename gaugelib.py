...
class DrawGauge2(ini):
    ...
    def draw_background1(self, divisions=100):
        ...
        self.canvas.create_arc(self.size/7, self.size/7, self.size-self.size/7, self.size-self.size/7,
                               ...
                               outline = "orange")
        self.readout = self.canvas.create_text(self.size/2,4*self.size/5, font=("Arial",int(self.size/18),'bold'),fill="black", text='')
    ...
    def draw_tick(self,divisions=100):
        ...
        label = self.unit
        self.canvas.create_text(self.size/2,2*self.size/5, font=("Arial",int(self.size/20)),fill="black", text=label,angle=0)
        label = ''
        self.canvas.create_text(self.size/2,3*self.size/5, font=("Arial",int(self.size/18),'bold'),fill="black", text=label,angle=0)
        self.readout = self.canvas.create_text(self.size/2,4*self.size/5, font=("Arial",int(self.size/18),'bold'),fill="black", text='')
    ...
    def set_value(self, number: (float, int)):
        ...
        self.readout = self.canvas.create_text(self.size/2,4*self.size/5, font=("Arial",int(self.size/14),'bold'),fill="black", text=label,angle=0)
...
class DrawGauge3(ini):
    ...
    def draw_background1(self, divisions=100):
        ...
        self.canvas.create_arc(self.size/7, self.size/7, self.size-self.size/7, self.size-self.size/7,
                               ...
                               outline = "green")#style=tk.PIESLICE
        good_color = "red"
        self.canvas.create_arc(self.size/7, self.size/7, self.size-self.size/7, self.size-self.size/7,
