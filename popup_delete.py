...
class TranslucentWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        labelA = QLabel(self)
        labelA.setText('Are You Sure')
        labelA.move(420, 220)
        labelA.setStyleSheet('background-color:white;font-family:Arial Bold;font-size:25px;')

        labelB = QLabel(self)
        labelB.setText("You won't be able to revert this")
        labelB.move(370, 260)
        labelB.setStyleSheet('background-color:white;font-family:Times New Roman Bold;font-size:19px;')


        btn = QPushButton('NO', self)
        ...
        btn = QPushButton('Yes, delete it !', self)
        btn.setStyleSheet("background-color:#4299ff;color:white;font-family:Arial;font-size:19px;border-style: outset;border-width: 2px;border-color: black;padding: 4px;")
        btn.resize(150,50)
        btn.move(340, 320)
        btn.clicked.connect(self._onyes)
