...
##        entry_d1.insert(0,d1)
    ...
    for frame in (f1, f2, f3, f4,f5,f6,f7,f8,f_addnewuser,f_setting,f_ins_setting,f_servicemode,f_servicemode1,f_about,f_graph,fcontact,f_result,f_result_data,f_damper):
    ...
    Label(master=f_damper,width=19,height=0,bg='white',fg='black', text="Damper",font=('Arial', 15,'bold')).place(x=60,y=39)
    toggle = Toggle(f_damper)
    toggle.configure(bg='white')
    toggle.place(x=120,y=70,height=75)
...
###########################################RESULT SCREEN###########################################################
    ...
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='Temperature',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=175,y=150,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='Duration',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=335,y=150,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='User',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=495,y=150,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='Status',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=655,y=150,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='Show Result',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=815,y=150,width=160,height=50)


    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff',relief='raised',borderwidth=2, text='',font=('Arial',15,'bold')).place(x=15,y=200,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=175,y=200,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=335,y=200,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=495,y=200,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=655,y=200,width=160,height=50)
    Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=815,y=200,width=160,height=50)
       
    l_1=Button(master=f_result_data.scrollFrame.viewPort,bg='#4299ff',fg='white', text="Back",font=('Arial', 16,'bold'), command=back).place(x=805,y=70,width=150,height=45)
...
####    widgetstart.place(x=85,y=110,width=200,height=90)
    ...
    label_results=Button(master=f1,text="Results",font=('Arial',22,'bold'),fg='black',relief='raised',borderwidth=0,command=change_result).place(x=420,y=114)
    ...
    label_damper=Button(master=f1,text="Damper",font=('Arial',22,'bold'),fg='black',relief='raised',borderwidth=0,command=change_damper).place(x=420,y=374)
...
#############################################tkinter_graph######################
    ...
    def back4():
        clientsocket,address=s11.accept()
        clientsocket.send(bytes("Open1!","utf-8"))
        label_start=Button(master=f1,text="View Running Test",font=('Arial',19,'bold'),fg='black',relief='flat',borderwidth=0,command=change_graph).place(x=56,y=94,height=92,width=256)
   
        raise_frame(f1)

    def stop_test():
        global list_set,l_1,l_2,list_stop,halt_timer,gfg1,s11
    ...
    def cut_top():
        ...
        top.geometry('1024x600+10+10')
        top.overrideredirect(True)
        top.configure(bg='red')
        canvas = Canvas(top)
        canvas.configure(bg='white',highlightbackground='#4299ff',highlightthickness=8)
        canvas.place(x=200,y=200,width=420)
        Label(top,fg='black',font=('Arial',20),bg='white',text="Test").place(x=362,y=255)
        Label(top,font=('Arial',16),bg='white',text="Are you sure you want to stop this test?" ).place(x=220,y=290)

        Button(top, text="Yes! Stop it",fg='white',bg='#4299ff',font=('Arial',16), command=lambda:[stop_test(),top.destroy()],bd=2).place(x=240,y=350,width=140,height=50)

        Button(top, text="Cancel",fg='white',bg='#4299ff',font=('Arial',16), command=top.destroy).place(x=420,y=350,width=120,height=50)

        top.wm_attributes("-transparentcolor",'red')
        top.wait_visibility(top)
        


        #Button(top, text="Yes",fg='white',bg='#4299ff',font=('Arial',16), command=lambda:[stop_test(),top.destroy()]).place(x=400,y=400)
        
        #Button(top, text="No",fg='white',bg='#4299ff',font=('Arial',16), command=do_destroy).pack(x=600,y=400)
...
##            e_time1.config(bg='white',fg='black', font=('Arial', 20,'bold'),relief=GROOVE,borderwidth=0,justify=LEFT)
##            e_time1.place(x=790,y=362,width=80)
...
##################################################################result screen#######################################
    def user_show(qt):
        ...
        degree_sign=u'\u00B0'
        Label(f_result,text=temp_list[1],bg='white',fg='black',font=('Arial',15,'bold')).place(x=390,y=95)
        Label(f_result,text=temp_list[2],bg='white',fg='black',font=('Arial',15,'bold')).place(x=390,y=192)
        Label(f_result,text=temp_list[3],bg='white',fg='black',font=('Arial',15,'bold')).place(x=390,y=292,width=100)
    ...
    def graph_result_show():
        ...
        global variable2,list_names,dict_user,figresult,ax2,canvasresult1
        imgresult = Image.open("resultscreen.png")
        filenameresult = ImageTk.PhotoImage(imgresult)
        canvasresult = Canvas(f_result,height=500,width=1024)
        ...
        if(x2=='infinity' and x3=='infinity'):
            ...
            Label(f_result,text='infinity',bg='white',fg='black',font=('Arial',15,'bold')).place(x=390,y=192,width=120)
        ...
        if(x2=='infinity' and x3=='infinity'):
            ...
            duration=str(x2)+'hrs'+str(x3)+'mins'
        dict_user[result_name]=[date1,g_temp,duration,x4]
        list_result=[]
        del df
        del df2
        del hh_temp
        ...
        f_result_data.scrollFrame.pack(side="top", fill="both", expand=True)
        Button(master=f_result_data.scrollFrame.viewPort,bg='#4299ff',fg='white', text="Back",font=('Arial', 16,'bold'), command=back).place(x=805,y=70,width=150,height=45)
        ...
        Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='User',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=495,y=150,width=160,height=50)
        Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='Status',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=655,y=150,width=160,height=50)
        Label(f_result_data.scrollFrame.viewPort,fg='black',bg='white', text='Show',borderwidth=2,relief='raised',font=('Arial',15,'bold')).place(x=815,y=150,width=160,height=50)
        ...
        if (len(list_result)==0):
            current=200
            Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff',relief='raised', text='',font=('Arial',15,'bold')).place(x=15,y=current,width=160,height=70)
            Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=175,y=current,width=160,height=70)
            Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=335,y=current,width=160,height=70)
            Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=495,y=current,width=160,height=70)
            Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=655,y=current,width=160,height=70)
            Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=815,y=current,width=160,height=70)
            
        else:    
            print(list_result[0])
            c_current=200
            for fz2 in list_result:
                Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff',relief='raised', text=dict_user[fz2][0],font=('Arial',15,'bold')).place(x=15,y=c_current,width=160,height=70)
                Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text=dict_user[fz2][1],relief='raised',font=('Arial',15,'bold')).place(x=175,y=c_current,width=160,height=70)
                Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text=dict_user[fz2][2],relief='raised',font=('Arial',15,'bold')).place(x=335,y=c_current,width=160,height=70)
                Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text=dict_user[fz2][3],relief='raised',font=('Arial',15,'bold')).place(x=495,y=c_current,width=160,height=70)
                Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=655,y=c_current,width=160,height=70)
                Label(f_result_data.scrollFrame.viewPort,fg='black',bg='#f7f7ff', text='',relief='raised',font=('Arial',15,'bold')).place(x=815,y=c_current,width=160,height=70)
        ...
        for last_1 in list_result:
            a=last_1
            Button(f_result_data.scrollFrame.viewPort,bg='#4299ff',fg='white', text="Show Result",font=('Arial',10,'bold'), command=lambda x=a:user_show(x)).place(x=835, y=current_1,width=85,height=50)
            print(list_faisal)
            if(len(list_faisal)>2):
                del list_faisal[0]
            list_faisal.append(current_1)
