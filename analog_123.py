...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setGeometry(680,245,300, 300)
        ...
        self.setWindowTitle("Temperature Gauge")
...
##my_gauge1=AnalogGaugeWidget()
##
##timer = QTimer()
##timer.timeout.connect(my_gauge.updateTime)
##timer.start(60)
##my_gauge.show()
##tk=Tk()
##my_gauge.close()
...
##my_gauge.show()
##my_gauge1.show()
##my_gauge1.setGeometry(720,155,250, 300)
##
###self.setStyleSheet("background:transparent;")
##my_gauge1.setStyleSheet("background-color:white")
##tk.mainloop()
##
##sys.exit(app.exec_())
